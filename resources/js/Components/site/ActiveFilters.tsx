...
const labels = {
    ar: {
        keys: {
            ...
            featured: "مميّزة", garden: "حديقة", roof: "روف", dressing: "غرفة ملابس", new: "إطلاق جديد",
    ...
    en: {
        keys: {
            ...
            featured: "Featured", garden: "Garden", roof: "Roof", dressing: "Dressing room", new: "New launch",
        } as Record<string, string>,
        sale: "Sale",
        rent: "Rent",
        yes: "Yes",
