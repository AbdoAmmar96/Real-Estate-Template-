...
const copy = {
    ar: {
        crumb: "اتصل بنا",
        title: "اتصل بنا",
        desc: "اكتب ما تبحث عنه وميزانيتك، وسنعود إليك خلال ساعتي عمل بقائمة مبدئية.",
        ...
        note: "لا مكالمات تسويقية. بياناتك تبقى لدينا.",
        sentTitle: "استلمنا طلبك",
        sentText: "سنتصل بك من رقم واحد فقط",
        again: "أرسل طلبًا آخر",
        infoPhone: "هاتف",
        infoWa: "واتساب",
        infoMail: "بريد إلكتروني",
        infoHours: "مواعيد العمل",
        hours: "السبت – الخميس · 10ص – 8م",
        offices: "مكاتبنا",
        reviews: "تقييمات جوجل",
        reviewsText: "اطّلع على تجارب عملاء اشتروا معنا فعلًا — كل التقييمات على جوجل دون فلترة.",
        reviewsRead: "اقرأ التقييمات",
        reviewsWrite: "قيّمنا على جوجل",
        waCta: "تواصل معنا عبر واتساب",
        stepsTitle: "بعد إرسال الطلب",
        stepsSub: "ثلاث خطوات ثابتة، ومستشار واحد مسؤول عن ملفك من أول مكالمة.",
        faqTitle: "أسئلة شائعة",
        faqSub: "أكثر ما يُسأل عنه قبل أول مكالمة.",
    },
    en: {
        crumb: "Contact",
        title: "Contact us",
