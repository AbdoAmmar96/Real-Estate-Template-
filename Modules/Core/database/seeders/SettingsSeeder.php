    ...
    public function run(): void
    {
        $groups = [
            ...
            'contact' => [
                ...
                'email' => '',
                'address' => '',
                // الإحداثيات فاضية عن قصد — الخريطة بتختفي لحد ما الأدمن
                // يحطّ موقع المكتب الحقيقي، بدل ما تعرض مكان غلط
                'latitude' => '',
                'longitude' => '',
                'hours' => '',
            ],

            // بانر الرئيسية الترويجي — فاضي يعني الكومبوننت بيستخدم نصه
            // الافتراضي («أضف عقارك»)، مش بيختفي
            'promo' => [
                'title' => '',
                'title_en' => '',
                'body' => '',
