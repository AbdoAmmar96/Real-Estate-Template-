...
class SettingsController extends Controller
{
    ...
    public const LABELS = [
        ...
        'address' => 'العنوان',
        'latitude' => 'خط عرض المكتب (Latitude)',
        'longitude' => 'خط طول المكتب (Longitude)',
        'hours' => 'ساعات العمل',
        // promo
        'title' => 'عنوان البانر (عربي)',
        'title_en' => 'عنوان البانر (إنجليزي)',
        'body' => 'نص البانر (عربي)',
        'body_en' => 'نص البانر (إنجليزي)',
        'cta' => 'نص الزر (عربي)',
        'cta_en' => 'نص الزر (إنجليزي)',
        'url' => 'رابط الزر',
        'image' => 'صورة خلفية البانر',
        // social
        'facebook' => 'فيسبوك',
        'instagram' => 'إنستجرام',
        'tiktok' => 'تيك توك',
